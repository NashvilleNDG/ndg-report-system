    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 pr-11 text-sm text-gray-800 placeholder-gray-400 transition-all outline-none"
          onFocus={e  => { e.currentTarget.style.borderColor = C.cyan; e.currentTarget.style.boxShadow = `0 0 0 3px ${C.cyan}20`; }}
  ...
  return (
    <div className="flex items-center gap-4 px-5 py-4">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[10px] font-bold uppercase tracking-widest mb-0.5" style={{ color: `${C.cyan}90` }}>{label}</p>
    ...
    <div className="max-w-xl mx-auto space-y-5 page-content">
      ...
      <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-100">
        ...
        <div className="relative h-40 flex items-center justify-center overflow-hidden"
          style={{ background: `linear-gradient(145deg, ${C.dark} 0%, ${C.navy} 45%, ${C.mid} 100%)` }}>

          {/* Large decorative circles */}
          <div className="absolute -top-10 -left-10 w-48 h-48 rounded-full opacity-10"
            style={{ background: C.cyan, filter: "blur(1px)" }} />
          <div className="absolute -bottom-16 -right-10 w-56 h-56 rounded-full opacity-10"
            style={{ background: C.cyan2, filter: "blur(1px)" }} />
          <div className="absolute top-4 right-16 w-24 h-24 rounded-full opacity-5"
            style={{ background: C.cyan3 }} />

          {/* Dot grid */}
          <svg className="absolute inset-0 w-full h-full opacity-[0.06]" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="p" width="22" height="22" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="1.3" fill={C.cyan}/>
              </pattern>
            </defs>
            <rect width="100%" height="100%" fill="url(#p)" />
          </svg>

          {/* Cyan horizontal glow line */}
          <div className="absolute bottom-0 left-0 right-0 h-px"
            style={{ background: `linear-gradient(90deg, transparent 0%, ${C.cyan}90 50%, transparent 100%)` }} />
          ...
          <div className="relative z-10 flex flex-col items-center gap-3">
            ...
            <div className="relative">
              <div className="w-20 h-20 rounded-full p-[3px]"
                style={{ background: `linear-gradient(135deg, ${C.cyan}, ${C.cyan2}, white)` }}>
                <div className="w-full h-full rounded-full flex items-center justify-center"
                  style={{ background: `linear-gradient(145deg, ${C.navy}, ${C.mid})` }}>
                  <span className="font-black text-[28px] tracking-tight select-none"
                    style={{ color: "white", textShadow: `0 0 20px ${C.cyan}, 0 2px 6px rgba(0,0,0,0.5)` }}>
                    {initial}
                  </span>
                </div>
              </div>
        ...
        {/* ── Identity section ───────────────────────────────────────────── */}
        <div className="bg-white px-6 pt-5 pb-2 flex flex-col items-center text-center">
          <h1 className="text-xl font-extrabold text-gray-900 leading-tight tracking-tight">{me?.name ?? "—"}</h1>
          <p className="text-sm text-gray-400 mt-0.5">{me?.email ?? "—"}</p>
          {/* Role pill */}
          <div className="mt-3 inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-[11px] font-bold border"
            style={{ color: C.cyan, background: `${C.cyan}12`, borderColor: `${C.cyan}35` }}>
        ...
        {/* Divider */}
        <div className="mx-6 my-4 h-px" style={{ background: `linear-gradient(90deg, transparent, ${C.cyan}30, transparent)` }} />

        {/* ── Info rows ──────────────────────────────────────────────────── */}
        <div className="bg-white pb-5 divide-y" style={{ divideColor: "#f1f5f9" }}>
          <InfoRow
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-lg overflow-hidden">
        ...
        {/* Header strip */}
        <div className="h-1 w-full" style={{ background: `linear-gradient(90deg, ${C.navy}, ${C.cyan}, ${C.cyan2})` }} />

        <div className="px-6 pt-5 pb-2 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
            style={{ background: `linear-gradient(135deg, ${C.navy}, ${C.mid})`, boxShadow: `0 4px 12px ${C.cyan}30` }}>
          ...
          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold border"
            style={{ color: C.cyan, background: `${C.cyan}0e`, borderColor: `${C.cyan}30` }}>
        ...
        <form onSubmit={submit} className="px-6 pb-6 space-y-4">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <button type="submit" disabled={saving}
              ...
              style={{ background: `linear-gradient(135deg, ${C.navy} 0%, ${C.mid} 40%, ${C.cyan} 100%)`, boxShadow: `0 4px 16px ${C.cyan}45` }}
