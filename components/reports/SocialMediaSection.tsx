      ...
      <div className={`bg-gradient-to-r ${color} px-5 py-4 flex items-center gap-3`}>
        ...
        {data.engagement != null && (
          <div className="ml-auto glass px-3 py-1 rounded-full">
            <span className="text-white text-xs font-semibold">{formatPercent(data.engagement)} engagement</span>
          </div>
        )}
      </div>
      <div className="p-5">
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-2.5">
        <div className="w-8 h-8 bg-indigo-50 rounded-lg flex items-center justify-center">
          <svg className="w-4.5 h-4.5 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
